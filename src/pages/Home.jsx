          ...
          <div className="max-w-2xl mx-auto">
            <div className="h-72 sm:h-96 w-full relative">
              ...
              <div className="absolute top-6 left-6 flex gap-3">
                ...
                {selectedItem.isNew && <span className="bg-blue-500 text-white px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-xl">New Arrival</span>}
              </div>
            </div>
            <div className="p-8 md:p-12 -mt-16 relative z-10 bg-[#080808] rounded-t-3xl border-t border-white/5">
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
                <div>
                  ...
                  <h2 className="text-4xl md:text-5xl font-display mt-4 tracking-tight">{selectedItem.name}</h2>
                </div>
                <div className="flex flex-col items-end">
                  <span className="text-4xl font-display text-primary">Rs. {selectedItem.price}</span>
              ...
              <p className="text-text-muted text-lg leading-relaxed mb-8 font-medium">{selectedItem.description || selectedItem.shortDescription}</p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-10">
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5 flex flex-col items-center">
                  ...
                  <p className="text-[10px] text-text-muted font-bold uppercase tracking-widest">Prep Time</p>
                  <p className="text-sm font-bold">{selectedItem.prepTimeMinutes || 15} Min</p>
                </div>
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5 flex flex-col items-center">
                  <Utensils className="w-5 h-5 text-text-muted mb-2" />
                  <p className="text-[10px] text-text-muted font-bold uppercase tracking-widest">Calories</p>
                  <p className="text-sm font-bold">{selectedItem.calories || 'N/A'}</p>
                </div>
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5 flex flex-col items-center col-span-2 sm:col-span-1">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <div className="flex items-center gap-6 bg-white/5 rounded-2xl px-6 py-4 border border-white/10 w-full sm:w-auto justify-between sm:justify-start">
                  ...
                  <span className="w-8 text-center font-display text-2xl">{itemQty}</span>
                ...
                <motion.button
                  ...
                  className="flex-1 w-full py-5 bg-primary text-white rounded-2xl font-bold tracking-[0.2em] uppercase text-sm shadow-xl shadow-primary/20 hover:opacity-90 transition-all disabled:opacity-30 flex items-center justify-center gap-3"
                >
